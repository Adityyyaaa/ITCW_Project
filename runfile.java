...
public class runfile {
    public static void main(String[] args) {
        Result Ned = new Result("Aditya", 19, 1, "Mathematics", true, true, 50);
        Ned.displayResult();
        System.out.println("");
        Result Sam = new Result("Abhisekh", 45, 4, "Physics", true, false, 27);
        Sam.displayResult();
        System.out.println("");
        Result John = new Result("Siddhant", 34, 2, "Chemistry", false, true, 55);
        John.displayResult();
    }
}
...
class Student extends Registration {
    ...
    public void assignProf() {
        if (subject == "Mathematics")
            professor = "Nipun Verma";
        else if(subject == "Physics")
            professor = "Ashok Singhla";
        else
            professor = "Lovekush Pradhan";
    }
